...
const emailVerification = async (req, res) => {
    ...
    try {
      ...
      transporter.sendMail(mailOptions, (error, info) => {
        ...
        const hashOtp = bcrypt.hashSync(otp.toString(), saltRounds, expiresIn="2m");
...
module.exports = {emailVerification, verifyOtp, userDetails, register, login, createBlogs, GetAllBlogsById, allBlogs, updateBlogs, deleteBlogs}